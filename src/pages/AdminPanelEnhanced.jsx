            ...
            <div className="card admin-header">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    ...
                    <div className="admin-tabs">
                        ...
                        {selectedStudent && <button className={`btn ${activeTab === 'tasks' ? 'btn-primary' : 'btn-secondary'}`}>📋 Tasks</button>}
                    ...
                    <div style={{
                        ...
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            >
                                ...
                                <option value="select-existing">📚 Select Existing Quiz</option>
                            </select>
                        </div>

                        {selectedQuiz === 'select-existing' && (
                            <div style={{ marginBottom: '20px', maxHeight: '300px', overflowY: 'auto', border: '1px solid var(--border)', borderRadius: '8px', padding: '12px' }}>
                                <p style={{ fontSize: '12px', color: 'var(--text-muted)', marginBottom: '12px' }}>Select from available quizzes:</p>
                                {/* Placeholder - would fetch available quizzes */}
                                <p style={{ fontSize: '12px', color: 'var(--text-muted)' }}>No existing quizzes found</p>
                            </div>
                        )}
